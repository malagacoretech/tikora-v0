...
var VERSION = 'tikora-captura-v104'; /* v98: la tarjeta de fotos de hoy dice la verdad (pendientes por c.f, repetidas no son perdidas, el arbitro es el cuadre) y habla en tono normal */
var ASSETS = [
  '/captura.html',
  '/captura.webmanifest',
